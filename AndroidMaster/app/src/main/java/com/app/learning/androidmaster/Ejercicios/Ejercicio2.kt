package com.app.learning.androidmaster.Ejercicios
...
fun main() {
    ...
    println("The movie ticket price for a person aged $child is  \$${ticketPriceWhen(child, isMonday)}.")
    println("The movie ticket price for a person aged $adult is \$${ticketPriceWhen(adult, isMonday)}.")
    println("The movie ticket price for a person aged $senior is \$${ticketPriceWhen(senior, isMonday)}.")
}
...
fun ticketPriceWhen(age: Int, isMonday: Boolean): Int {
    return when (age) {
        in 0..12 -> 15
